...
--Update 8/21 JB
--Add new table that has longitude and latitude fields
CREATE TABLE "philadelphia_home_sales_geocode" (
    "id" int   NOT NULL,
    "basements" VARCHAR(255)   NULL,
    "building_code_description" VARCHAR(255)   NULL,
    "category_code_description" VARCHAR(255)   NULL,
	...
	"latitude" float	NULL
    CONSTRAINT "pk_philadelphia_home_sales_geocode" PRIMARY KEY (
        "id"
     )
);
